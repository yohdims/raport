<?php
$head = array("#","NIS","Nama Siswa","Program Keahlian","Kelompok","Action");
?>
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['kelompok']; ?></td>
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kelas_siswa/index/<?= $data['id_kelas_siswa']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kelas_siswa/hapus/<?= $data['id_kelas_siswa']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
