<?php
$head = array("#","NIS","Nama Siswa","Jenis Kelamin","Action");
?>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $this->M_1Settings->jk($data['jk']); ?></td>
                                <td>
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>siswa/index/<?= $data['id_siswa']; ?>" >
                                    ...
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>siswa/hapus/<?= $data['id_siswa']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
