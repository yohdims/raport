<?php
$head = array("#","Tahun Ajaran","Action");
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>ta/index/<?= $data['id_ta']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>ta/hapus/<?= $data['id_ta']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
