            ...
            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <select required class="form-control show-tick" name='id_guru'>
                            <option value="">Pilih</option>
                        <?php foreach ($guru as $guru ) {?>
                        <option value="<?= $guru['id_guru'];?>" <?php if($data[1]==$guru['id_guru']){echo "selected"; }?>><?= $guru['nama_guru'];?></option>
                        <?php } ?></select>
                    </div>
                </div>
            </div>
