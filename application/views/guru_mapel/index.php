<?php
$head = array("#","Nama Guru","Kelas","Mapel","Action");
?>
<!-- Select Plugin Js -->
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>guru_mapel/index/<?= $data['id_guru_mapel']; ?>" >
                                    ...
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>guru_mapel/hapus/<?= $data['id_guru_mapel']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
