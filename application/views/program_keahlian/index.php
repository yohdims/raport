<?php
$head = array("#","Nama Program Keahlian","Action");
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>program_keahlian/index/<?= $data['id_program_keahlian']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>program_keahlian/hapus/<?= $data['id_program_keahlian']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
