...
?>
<form method="POST" action="<?= base_url().$this->session->userdata("hak_akses")."/";?>kompetensi_dasar/input" enctype="multipart/form-data">
    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <select required class="form-control show-tick" name='id_guru_mapel'>
                            ...
                            <option value="<?= $guru_mapel['id_guru_mapel'];?>" <?php if($data[2]==$guru_mapel['id_ta']){echo "selected"; }?>><?= $guru_mapel['nama_guru'];?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
