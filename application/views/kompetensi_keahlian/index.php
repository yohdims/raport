<?php
$head = array("#","Nama Program Keahlian","Nama Kompetensi Keahlian","Action");
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kompetensi_keahlian/index/<?= $data['id_kompetensi_keahlian']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kompetensi_keahlian/hapus/<?= $data['id_kompetensi_keahlian']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
