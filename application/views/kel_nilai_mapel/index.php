<?php
$head = array("#","Kelompok Nilai Mapel","Action");
?>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kel_nilai_mapel/index/<?= $data['id_kel_nilai_mapel']; ?>" >
                                    ...
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kel_nilai_mapel/hapus/<?= $data['id_kel_nilai_mapel']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
