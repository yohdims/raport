<?php
$head = array("#","NIS","Nama Siswa","Action");
?>
<!-- Select Plugin Js -->
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2>
                            <?= $title; ?> <?= $kelas_tahunan->nama_kelas?>
                        </h2>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>anggota_kelas/hapus/<?= $data['id_anggota_kelas']; ?>/<?= $data['id_kelas_tahunan']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
