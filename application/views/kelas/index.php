<?php
$head = array("#","Kelas","Nama Kelas","Program Keahlian","Kelompok","Action");
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['kelompok']; ?></td>
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kelas/index/<?= $data['id_kelas']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kelas/hapus/<?= $data['id_kelas']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
