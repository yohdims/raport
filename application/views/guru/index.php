<?php
$head = array("#","NIP","Nama Guru","No Telepon","Action");
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['no_telp']; ?></td>
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>guru/index/<?= $data['id_guru']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>guru/hapus/<?= $data['id_guru']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
