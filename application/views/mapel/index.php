                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['kkm']; ?></td>
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>mapel/index/<?= $data['id_mapel']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>mapel/hapus/<?= $data['id_mapel']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
