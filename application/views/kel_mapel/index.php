<?php
$head = array("#","Kelompok Mapel","Nilai SKM","Action");
?>
                 ...
                 <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no; ?></td>
                                <td><?= $data['kelompok_mapel']; ?></td>
                                <td><?= $data['skm']; ?></td>
                                <td>
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kel_mapel/index/<?= $data['id_kel_mapel']; ?>" >
                                    ...
                                    <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>kel_mapel/hapus/<?= $data['id_kel_mapel']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
