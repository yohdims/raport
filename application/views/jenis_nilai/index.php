<?php
$head = array("#","Jenis Nilai","Bobot","Action");
?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no; ?></td>
                                    <td><?= $data['jenis_nilai']; ?></td>
                                    <td><?= $data['bobot']; ?></td>
                                    <td>
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>jenis_nilai/index/<?= $data['id_jenis_nilai']; ?>" >
                                        ...
                                        <a href="<?= base_url().$this->session->userdata("hak_akses")."/";?>jenis_nilai/hapus/<?= $data['id_jenis_nilai']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
