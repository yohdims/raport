...
class Nilai extends CI_Controller {
	...
	public function kelas_siswa($id)
	{
		...
		if(!empty($this->input->post('cek'))){
			...
			$this->data['all']=$this->M_Kelas_Siswa->getAllperKelasNilai($id,$id_kompetensi_dasar,$id_jenis_nilai);
			...
			$data	= array('id_kompetensi_dasar'=>$id_kompetensi_dasar,'id_jenis_nilai'=>$id_jenis_nilai,'nilai'=>$this->input->post('nilai'));
			if($this->M_Nilai->inputan($data)){
