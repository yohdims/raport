...
class Mapel extends CI_Controller {
	...
	public function input()
	{
		...
		if($id==0){	
			if($this->M_Mapel->insert($data)){
				$this->session->set_flashdata('message', 'Berhasil tambah data');
			}
		}elseif ($this->M_Mapel->update($data)) {// success
